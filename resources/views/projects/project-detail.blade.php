  ...
  <ol class="list-none inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse" style="padding: 0 !important;">
    ...
    <li>
      <div class="flex items-center">
        ...
        <a href="{{route("proyek")}}" class="ms-1 text-sm font-medium text-slate-700 hover:text-blue-600 md:ms-2 dark:text-slate-400 dark:hover:text-white">Projek</a>
      </div>
    </li>
...
<h1 class="text-3xl font-medium">{{$project->name}}</h1>
 <p class="text-sm text-slate-700 dark:text-slate-400">{{$project->summary}}.</p>
</div>
