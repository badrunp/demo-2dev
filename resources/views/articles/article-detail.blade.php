...
<nav class="flex px-5 py-3 text-gray-700 border border-gray-200 bg-gray-50 dark:bg-gray-800 dark:border-gray-700 mb-4" aria-label="Breadcrumb">
  <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
    ...
    <li>
      <div class="flex items-center">
        ...
        <a href="{{route("artikel")}}" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Artikel</a>
      </div>
    </li>
    <li aria-current="page">
      <div class="flex items-center overflow-x-hidden w-[180px] sm:w-[240px] md:w-full">
        ...
        <span class="block ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400 truncate">{{$article->title}}</span>
      </div>
    </li>
  </ol>
</nav>
