...
<th scope="row" class="flex items-center px-6 py-4 text-slate-900 whitespace-nowrap dark:text-white">
                        ...
                        <p class="text-base font-semibold">{{$article->title}}</p>
...
<div id="dropdownDotsHorizontal-{{$article->id}}" class="z-10 hidden bg-white divide-y divide-slate-100 rounded-lg shadow w-44 dark:bg-slate-700 dark:divide-slate-600 border border-e-slate-300 dark:border-slate-800">
    <ul class="py-2 text-sm text-slate-700 dark:text-slate-200" aria-labelledby="dropdownMenuIconHorizontalButton-{{$article->id}}">
          <li>
...
<span>Hapus</span></button>
    ...
    <div class="relative w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            @else
            <tr class="bg-white border-b dark:bg-slate-900 dark:border-slate-700">
              <td class="px-6 py-4 text-sm text-slate-700 dark:text-slate-400" colspan="7">
