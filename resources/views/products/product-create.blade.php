      ...
      <ol class="inline-flex items-center space-x-1 md:space-x-3">
         ...
         <li>
            <div class="flex items-center">
               ...
               <a href="{{ route("products.create")}}" class="ml-1 text-sm font-medium text-slate-700 hover:text-blue-600 md:ml-2 dark:text-slate-400 dark:hover:text-white">Tambah</a>
            </div>
         </li>
      </ol>
   </nav>
   <div class="mb-8">
      <h1 class="mb-2 text-2xl font-medium">Tambah Daftar Produk</h1>
   </div>
   <form class="mb-8" method="POST" action="{{ route('products.store') }}">
      @csrf
      <div class="mb-4">
         ...
         <option value="" {{!old("service_id") ? "selected" : ""}}>Pilih Jenis Layanan</option>
      ...
      <div class="mb-4">
         ...
         <select id="packet_id" name="packet_id" class="border-slate-300 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-300 focus:border-blue-500 dark:focus:border-blue-600 focus:ring-blue-500 dark:focus:ring-blue-600 rounded-md shadow-sm block w-full p-2.5" >
          @if(session()->has("packet"))
          <option value="{{session()->get("packet")->id}}" selected>{{session()->get("packet")->name}}</option>
          @endif
         </select>
      ...
      <div class="mb-4 grid grid-cols-2 gap-2">
         ...
         <div>
            ...
            <x-text-input id="discount" class="block mt-1 w-full" type="number" name="discount" :value="old('discount')" placeholder="0" min="0" max="100"/>
      ...
      <div class="mb-4">
         ...
         <option  {{ old("status") == "unpublished" ? "selected" : ""}} value="unpublished">Unpublished</option>
         </select>
      ...
      <div class="mb-4">
         ...
         <option value="" {{!old("banner") ? "selected" : ""}}>Pilih Banner</option>
         <option {{ old("banner") == "terlaris" ? "selected" : ""}} value="terlaris">Terlaris</option>
         </select>
