...
<div class="flex items-center p-4 mb-4 text-sm text-yellow-800 rounded-lg bg-yellow-50 dark:bg-gray-800 dark:text-yellow-300" role="alert">
  ...
  <div>
    <span class="font-medium mb-1 block text-2xl">Hello, Selamat datang {{Auth::user()->name}}</span>
    
    @if(!$isComplate)
    <span class="block mb-3">Profil kamu belum lengkap, Silahkan lengkapi profil untuk mendapatkan pengalaman yang lebih baik.</span>
